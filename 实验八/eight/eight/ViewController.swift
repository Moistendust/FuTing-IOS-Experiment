...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let t1 = Teacher(firstName: "yi", lastName: "wang", age: 35, gender: Gender.male, title: "professor")
        let t2 = Teacher(firstName: "wei", lastName: "li", age: 42, gender: Gender.female, title: "lecturer")
        let s1 = Student(firstName: "minqi", lastName: "liu", age: 20, gender: Gender.male, stuNo: "2016110322")
        let s2 = Student(firstName: "xin", lastName: "li", age: 21, gender: Gender.male, stuNo: "2016110317")
        let s3 = Student(firstName: "ting", lastName: "fu", age: 20, gender: Gender.female, stuNo: "2016110452")
